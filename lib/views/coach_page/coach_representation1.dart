...
class CoachRepresentation1 extends StatefulWidget {
  const CoachRepresentation1({Key key}) : super(key: key);

  @override
  _CoachRepresentation1State createState() => _CoachRepresentation1State();
}

class _CoachRepresentation1State extends State<CoachRepresentation1> {
