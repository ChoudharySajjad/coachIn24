...
class CoachRepresentation3 extends StatefulWidget {
  const CoachRepresentation3({Key key}) : super(key: key);

  @override
  _CoachRepresentation3State createState() => _CoachRepresentation3State();
}

class _CoachRepresentation3State extends State<CoachRepresentation3> {
